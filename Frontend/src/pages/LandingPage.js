  ...
  return (
    <div style={{ fontFamily:"'Inter',-apple-system,sans-serif", background:T.bgPrimary, overflowX:'hidden', WebkitFontSmoothing:'antialiased' }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth:1280, margin:'0 auto', height:'100%', padding:'0 40px', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
          ...
          <Link to="/" style={{ display:'flex', alignItems:'center', gap:10, textDecoration:'none' }}>
            <div style={{ width:38, height:38, borderRadius:12, background:T.gradViolet,
              display:'flex', alignItems:'center', justifyContent:'center',
              color:'#fff', fontWeight:900, fontSize:18, fontFamily:"'Playfair Display',serif",
              boxShadow:'0 4px 12px rgba(139,92,246,0.3)' }}>G</div>
            <div>
              <div style={{ fontFamily:"'Playfair Display',serif", fontWeight:800, fontSize:22,
                color: T.textPrimary, letterSpacing:'-.01em', lineHeight:1.1 }}>GlowAI</div>
            </div>
          </Link>
          ...
          <div className="hidden md:flex" style={{ alignItems:'center', gap:12 }}>
            ...
            {/* Mode toggle */}
            <div style={{ display:'flex', background: T.bgSoft,
            ...
            <Link to="/login" style={{ fontSize:14, fontWeight:600, color: T.textPrimary,
              textDecoration:'none', padding:'8px 16px' }}>Sign In</Link>
      ...
      <section style={{ position:'relative', minHeight:'100vh', display:'flex', flexDirection:'column', overflow:'hidden', background: T.bgPrimary }}>
        ...
        <div style={{ position:'relative', zIndex:10, flex:1, display:'flex', alignItems:'center',
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', width:'100%' }}
            ...
            <div style={{ animation:'fadeUp .8s cubic-bezier(.16,1,.3,1) both' }}>
              ...
              {/* H1 */}
              {mode === 'customer' ? (
                <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:'clamp(48px,5vw,72px)',
              ...
              {/* Sub */}
              <p style={{ fontSize:18, fontWeight:400, color:T.textSub, lineHeight:1.80,
            ...
            <div className="hidden md:flex" style={{ justifyContent:'flex-end', animation:'floatY 9s ease-in-out infinite' }}>
              <div style={{ width:'100%', maxWidth:440, borderRadius:32,
                ...
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:32 }}>
                  <div>
                    <div style={{ fontSize:11, fontWeight:700, letterSpacing:'.16em', textTransform:'uppercase',
                      color:T.textMuted, marginBottom:6 }}>Skin Intelligence</div>
                    <div style={{ fontSize:18, fontWeight:800, color:T.textPrimary, fontFamily:"'Playfair Display',serif" }}>AI Skin Analysis</div>
                  </div>
                  <div style={{ display:'flex', alignItems:'center', gap:8, padding:'8px 16px', borderRadius:100,
                ...
                {/* AI badge */}
                <div style={{ display:'flex', alignItems:'center', gap:14, padding:'16px 20px', borderRadius:20,
                  background:'rgba(139,92,246,.04)', border:'1px solid rgba(139,92,246,.12)' }}>
                  <div style={{ width:36, height:36, borderRadius:10, background:T.gradViolet,
                    display:'flex', alignItems:'center', justifyContent:'center', fontSize:16, color:'#fff', flexShrink:0,
                    boxShadow:'0 6px 16px rgba(139,92,246,.25)' }}>✦</div>
                  <div>
        ...
        <div style={{ position:'relative', zIndex:10, borderTop:`1px solid ${T.borderPremium}`,
      ...
      <section id="services" style={{ background: T.bgSecondary, padding:'120px 40px' }}>
        <div style={{ maxWidth:1280, margin:'0 auto' }}>
          <SR style={{ textAlign:'center', marginBottom:80 }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:'clamp(36px,4vw,56px)', fontWeight:800,
            ...
            {features.map((f, i) => (
              <SR key={f.title} delay={i*65} scale>
                <div className="card card-edge" style={{ padding:'48px 40px', height:'100%', cursor:'default', display:'flex', flexDirection:'column' }}>
                  ...
                  <h3 style={{ fontFamily:"'Playfair Display',serif", fontSize:24, fontWeight:700,
                    color:T.textPrimary, marginBottom:16, lineHeight:1.3 }}>{f.title}</h3>
      ...
      <section id="intelligence" style={{ background: T.bgPrimary, padding:'120px 40px', position:'relative', overflow:'hidden' }}>
        <div style={{ position:'absolute', top:'10%', right:'-5%', width:600, height:600, borderRadius:'50%', pointerEvents:'none',
          background:'radial-gradient(circle,rgba(139,92,246,.04) 0%,transparent 70%)', filter:'blur(80px)' }}/>
        <div style={{ position:'absolute', bottom:'-10%', left:'-5%', width:600, height:600, borderRadius:'50%', pointerEvents:'none',
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, alignItems:'center' }}
            ...
            <SR className="order-2 md:order-1">
              <div style={{ animation:'floatY 8s ease-in-out infinite' }}>
                <div style={{ borderRadius:32, padding:40, background:'#FFFFFF',
                  ...
                  <div style={{ display:'flex', flexWrap:'wrap', gap:10 }}>
                    {['Facial Mapping','Skin Health','Beauty Score','AI Recommendations','Progress Tracking'].map(tag => (
                      <span key={tag} style={{ fontSize:12, fontWeight:700, padding:'8px 16px', borderRadius:100,
                        background:'rgba(139,92,246,.06)', border:'1px solid rgba(139,92,246,.12)',
                        color:T.lavender, letterSpacing:'.04em' }}>{tag}</span>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <SR className="order-1 md:order-2" delay={100}>
              ...
              <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:'clamp(36px,4vw,56px)',
            ...
            {WHY_US.map((item, i) => (
              <SR key={item.title} delay={i*55} scale>
                <div className="card" style={{ padding:'48px 40px', height:'100%' }}>
                  <div style={{ width:56, height:56, borderRadius:16, background:T.bgPrimary, border: `1px solid ${T.borderSubtle}`,
                    display:'flex', alignItems:'center', justifyContent:'center', fontSize:26, marginBottom:24, boxShadow: '0 4px 12px rgba(15,23,42,0.04)' }}>{item.icon}</div>
      ...
      <section id="pricing" style={{ background: T.bgPrimary, padding:'120px 40px', position:'relative', overflow:'hidden' }}>
        <div style={{ position:'absolute', top:'-10%', left:'50%', transform:'translateX(-50%)', width:800, height:400, pointerEvents:'none',
            ...
            {PRICING.map((plan, i) => (
              <SR key={plan.name} delay={i*80} scale>
                <div className={`card ${plan.tier==='premium' ? 'plan-popular' : ''}`}
                  style={{ padding:'56px 40px', height:'100%', display:'flex', flexDirection:'column', position:'relative',
                  ...
                  <div style={{ marginBottom:40 }}>
                    <div style={{ fontSize:12, fontWeight:700, letterSpacing:'.16em', textTransform:'uppercase',
                      color: plan.tier==='premium' ? T.lavender : plan.tier==='business' ? T.champagne : T.textMuted,
                      marginBottom:12 }}>{plan.name} Plan</div>
                    <div style={{ display:'flex', alignItems:'baseline', gap:6 }}>
                      <span style={{ fontFamily:"'Playfair Display',serif", fontSize:64, fontWeight:900,
                  ...
                  <ul style={{ listStyle:'none', display:'flex', flexDirection:'column', gap:16, marginBottom:48, flexGrow:1 }}>
                    {plan.features.map(f => (
                      <li key={f} style={{ display:'flex', alignItems:'flex-start', gap:12, fontSize:16, color:T.textPrimary, lineHeight:1.6 }}>
                        <span style={{ width:24, height:24, borderRadius:'50%', flexShrink:0, marginTop:2,
                          display:'flex', alignItems:'center', justifyContent:'center',
                  ...
                  <Ripple as={Link} to={plan.link} className={plan.tier==='free' ? 'btn-secondary' : 'btn-primary'}
                    style={{ width:'100%', padding:'18px 0', justifyContent:'center', fontSize: 15,
      ...
      <section id="testimonials" style={{ background: T.bgSection, padding:'120px 0', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ overflow:'hidden', position:'relative' }}
          ...
          <div style={{ display:'flex', gap:32, width:'max-content', padding:'0 40px',
            ...
            {[...TESTIMONIALS,...TESTIMONIALS].map((t, i) => (
              <div key={i} className="card" style={{
                ...
                <div style={{ display:'flex', alignItems:'center', gap:16 }}>
                  <div style={{ width:48, height:48, borderRadius:'50%', background:t.grad,
                    display:'flex', alignItems:'center', justifyContent:'center',
      ...
      <section style={{ background: T.bgPrimary, padding:'140px 40px', position:'relative', overflow:'hidden' }}>
        ...
        <SR style={{ textAlign:'center', position:'relative', zIndex:10, maxWidth:800, margin:'0 auto' }}>
          ...
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:'clamp(40px,5vw,72px)',
          ...
          <p style={{ fontSize:18, color:T.textSub, lineHeight:1.80, maxWidth:600, margin:'0 auto 48px' }}>
            {mode==='customer'
              ? 'Join 50,000+ customers across 12 countries. Get started free — no credit card required.'
        ...
        <div style={{ maxWidth:1280, margin:'0 auto', display:'flex', flexWrap:'wrap', alignItems:'center', justifyContent:'space-between', gap:24 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            <div style={{ width:36, height:36, borderRadius:10, background:T.gradViolet,
              ...
              boxShadow:'0 4px 12px rgba(139,92,246,.25)' }}>G</div>
