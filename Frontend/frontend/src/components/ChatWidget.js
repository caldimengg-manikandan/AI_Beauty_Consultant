...
export default function ChatWidget() {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      // Handle Context updates & Actions
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="bg-white/90 backdrop-blur-xl w-[350px] sm:w-[400px] h-[500px] rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-white/40 animate-fade-in-up">
          {/* Header */}
          <div className="bg-gradient-to-r from-pink-500 to-rose-500 p-4 text-white flex justify-between items-center shadow-md">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-pink-100 uppercase tracking-widest font-black">Online</p>
              </div>
            </div>
