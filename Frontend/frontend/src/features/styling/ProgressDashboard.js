            ...
            <div className="max-w-7xl mx-auto space-y-10">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            <span className="px-3 py-1 bg-indigo-100 text-indigo-600 text-[10px] font-black rounded-lg uppercase tracking-widest">Analytics Beta</span>
                        </div>
                        <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase italic">
                            Skin<span className="text-indigo-600">Evolution</span> Tracker
                        </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        {!progress?.can_compare ? (
                            <div className="bg-white p-12 rounded-[2.5rem] border border-slate-200 shadow-sm text-center space-y-6">
                                <div className="w-20 h-20 bg-indigo-50 rounded-3xl flex items-center justify-center text-indigo-600 text-3xl mx-auto border border-indigo-100">
                                    <FaChartLine />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {Object.entries(progress.metrics).map(([key, data]) => (
                                    <div key={key} className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm space-y-4">
                                        ...
                                        timeline.map((entry, idx) => (
                                            <div key={idx} className="flex-1 group/bar relative">
                                                ...
                                                <div className="space-y-0.5">
                                                    ...
                                                    ></div>
                                                    <div
                                                        className="w-full bg-indigo-500/40 transition-all hover:bg-indigo-400"
                    ...
                    <aside className="space-y-8">
                        ...
                        <div className="bg-indigo-600 p-8 rounded-[2.5rem] shadow-xl shadow-indigo-100 space-y-6 text-white overflow-hidden relative">
                            ...
                            <button className="w-full py-4 bg-white text-indigo-600 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all active:scale-95 shadow-lg">
